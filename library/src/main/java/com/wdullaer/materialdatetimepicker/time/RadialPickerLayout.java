...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void initialize(Context context, TimePickerController timePickerController,
        ...
        mIs24HourMode = AccessibilityManagerCompat.isTouchExplorationEnabled(mAccessibilityManager) || is24HourMode;
    ...
    private void transitionWithoutAnimation(int index) {
        ...
        ViewHelper.setAlpha(mSecondRadialTextsView, secondAlpha);
        ViewHelper.setAlpha(mSecondRadialSelectorView, secondAlpha);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            AccessibilityNodeInfoCompat.obtain(this).addAction(AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD);
            AccessibilityNodeInfoCompat.obtain(this).addAction(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD);
        }
    }
